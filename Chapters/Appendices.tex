...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.78\linewidth]{vhs_cal_spectra_slope}
	\includegraphics[width=0.78\linewidth]{wise_cal_spectra_slope}
	\includegraphics[width=0.78\linewidth]{2m_cal_spectra_slope}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1.1\linewidth]{WISE0855_ptsrc_onax_CH1_corner}
	\caption{WISE 0855 with point source fringing in Channel 1.}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=1.1\linewidth]{WISE0855_nofringe_full_400_corner}
