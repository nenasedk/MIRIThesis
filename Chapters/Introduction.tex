...
\parencite{Oliveira2015} %BDs with JWST
\parencite{Helling2014}% Brown dwarf atmospheres
\parencite{Cooper2003} %Brown dwarf clouds/cloud formation
\parencite{Madhusudhan2018a} %BD observations/atmospheres
\parencite{Burrows2018} % Brown dwarf models/spectra coolest dwarfs
\parencite{Marley2015} %Modelling brown dwarf and giant planet atmospheres
...
\parencite{Madhusudhan2011} %Wasp12b need year
...
\parencite{Danielski2018} % Atmospheric characterizaton with MIRI
