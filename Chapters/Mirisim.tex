...
\begin{figure}[t]
	\centering
	\includegraphics[width=\linewidth,trim=4cm 0cm 5.5cm 0cm, clip]{PosnCor_v7}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.8\linewidth]{RFC}
...
The cases with no fringing and with an extended source corrected by an extended source fringe flat show nearly identical SNRs of 22.3.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth,trim=4cm 3.5cm 4cm 4.5cm, clip]{VHS1256bCrossCorrTemplate}
...
Fig.\ref{fig:ccspec2mfull} shows similar results for 2M1207b. 
...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.47\linewidth,trim=4cm 0cm 1cm 0cm,clip]{0_VHS1256b_IFU_CrossCor_Test_H2O}
	\includegraphics[width=0.47\linewidth,trim=4cm 0cm 1cm 0cm,clip]{0_VHS1256b_IFU_CrossCor_Test_H2S}
	\includegraphics[width=0.47\linewidth]{0_WISE0855_IFU_CrossCor_Test_NH3}
	\includegraphics[width=0.47\linewidth]{0_WISE0855_IFU_CrossCor_Test_CO}
	\includegraphics[width=0.47\linewidth,trim=4cm 0cm 1cm 0cm,clip]{0_2M1207b_IFU_CrossCor_Test_CO}
	\includegraphics[width=0.47\linewidth,trim=4cm 0cm 1cm 0cm,clip]{0_2M1207b_IFU_CrossCor_Test_CH4}
