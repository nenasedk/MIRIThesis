...
\begin{table}[t]
	...
	\begin{tabular}{l|lcccccc}
		...
		\midrule
		\multirow{3}{*}{VHS-1256b} & 1500 & 5--7.5  & No  & $833\pm1$   & $1.44\pm0.004$ & 2.95 &$0.565\pm0.003$\\
		                           & 10000 & 5--7.5 & Yes &  &  & 2.95 &\\
...
All of the retrievals significantly underestimated the internal temperature of VHS1256b, with posteriors shown in Fig. \ref{fig:postVHS_tr}.
...
\begin{figure}[t]
	\includegraphics[width=0.3\linewidth]{VHS1256bCH1_nofringe_tempradius_corner.png}
	\includegraphics[width=0.3\linewidth]{VHS1256bCH1_nofringe_tempradius_corner.png}
	\includegraphics[width=0.3\linewidth,trim = 0cm 0.5cm 0cm 0cm,clip]{vhsfull10000temprad.png}
	\caption{Interior temperature and planet radius posteriors for VHS1256b.
...
\begin{figure}[t]
	...
	\caption{Posterior distributions for the nuisance parameters of VHS-1256b, in the uncorrected point-source fringing case and using the modified Guillot profile. As most of these are non physical parameters, the P-T distribution provides a better metric for determining whether the atmospheric structure has been retrieved as opposed to specific parameter values.}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=\linewidth,trim=4.7cm 2cm 5.7cm 1cm,clip]{VHS_retrieved_models_ext_modelonly}
	\includegraphics[width=\linewidth,trim=4.7cm 2cm 5.7cm 2cm,clip]{VHS_retrieved_models_ext_narrow_fringe}
